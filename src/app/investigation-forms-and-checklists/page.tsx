...
const forms = [
  {
    id: 1,
    title: "Initial Occurrence Report Form",
    type: "Digital Form",
    date: "Updated: 2024",
    description: "Standard primary entry form for first responders and personnel to log key facts immediately following an incident.",
    image: "https://images.unsplash.com/photo-1554224154-26032ffc0d07?q=80&w=800&auto=format&fit=crop"
  },
  {
    id: 2,
    title: "Aircraft Wreckage Site Checklist",
    type: "Checklist",
    date: "Updated: 2023",
    description: "Procedural checklist for securing, surveying, and documenting an aeronautical incident site prior to moving debris.",
    image: "https://images.unsplash.com/photo-1503551723145-6c040742065b?q=80&w=800&auto=format&fit=crop"
  },
  {
    id: 3,
    title: "Marine Navigational Log Audit Form",
    type: "Audit Form",
    date: "Updated: 2023",
    description: "Template for extracting and logging marine vessel navigational data, radar tracks, and communications immediately post-incident.",
    image: "https://images.unsplash.com/photo-1456324504439-367cee3b3c32?q=80&w=800&auto=format&fit=crop"
  },
  {
    id: 4,
    title: "Derailment Investigation Initial Checklist",
    type: "Checklist",
    date: "Updated: 2024",
    description: "Quick-reference checklist for investigators reviewing track conditions, rolling stock specs, and signaling post-derailment.",
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          <ScrollReveal>
            ...
            <p style={{ 
              ...
              Standardized operational templates, pre-investigation forms, and tactical checklists to ensure consistency and rigor during field operations and reporting.
            </p>
            ...
            <div style={{ position: 'relative', width: '100%', maxWidth: '500px' }}>
              ...
              <input 
                ...
                placeholder="Search forms, checklists, or keywords..." 
                value={searchQuery}
                  ...
                  <div style={{ position: 'relative', height: '220px', overflow: 'hidden' }}>
                    ...
                    <div style={{ 
                      ...
                      textShadow: '0 2px 4px rgba(0,0,0,0.5)'
                        ...
                        <span style={{ fontSize: '1.2rem', fontWeight: 800 }}>Document Type: {item.type}</span>
                    </div>
                  </div>
