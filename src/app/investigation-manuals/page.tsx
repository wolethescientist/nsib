...
const manuals = [
  {
    id: 1,
    title: "Aviation Incident Investigative Guidelines v4",
    sector: "Aviation",
    date: "Updated: 2024",
    description: "The complete, standardized handbook for conducting an aeronautical investigation from dispatch to final sign-off.",
    image: "https://images.unsplash.com/photo-1542282088-fe8426682b8f?q=80&w=800&auto=format&fit=crop"
  },
  {
    id: 2,
    title: "Maritime Evidence Collection Protocol",
    sector: "Marine",
    date: "Updated: 2023",
    description: "Manual detailing strict protocols for extracting data from Voyage Data Recorders (VDR) and securing marine wreckages.",
    image: "https://images.unsplash.com/photo-1559406041-c7d2b2e98eb8?q=80&w=800&auto=format&fit=crop"
  },
  {
    id: 3,
    title: "Railway Track Pathology Handbook",
    sector: "Railways",
    date: "Updated: 2023",
    description: "In-depth guide for investigators assessing track tolerances, switch anomalies, and load distribution factors in mass transit.",
    image: "https://images.unsplash.com/photo-1474487548417-781cb71495f3?q=80&w=800&auto=format&fit=crop"
  }
];

export default function InvestigativeManualsPage() {
  const [searchQuery, setSearchQuery] = useState("");

  const filteredManuals = manuals.filter(manual => 
    manual.title.toLowerCase().includes(searchQuery.toLowerCase()) || 
    manual.description.toLowerCase().includes(searchQuery.toLowerCase()) ||
    manual.sector.toLowerCase().includes(searchQuery.toLowerCase())
  );
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          <ScrollReveal>
            ...
            <p style={{ 
              ...
              Comprehensive field manuals outlining exact procedural, technological, and tactical guidelines utilized by the Bureau's expert investigators across all modalities.
            </p>
            ...
            <div style={{ position: 'relative', width: '100%', maxWidth: '500px' }}>
              ...
              <input 
                ...
                placeholder="Search by sector, manual title..." 
                value={searchQuery}
        ...
        <div style={{ 
          ...
          {filteredManuals.length > 0 ? (
                  ...
                  <div style={{ position: 'relative', height: '220px', overflow: 'hidden' }}>
                    ...
                    <div style={{ 
                      ...
                      textShadow: '0 2px 4px rgba(0,0,0,0.5)'
                        ...
                        <span style={{ fontSize: '1.2rem', fontWeight: 800 }}>Sector: {item.sector}</span>
                    </div>
            ...
            <div style={{ 
              ...
              <h3 style={{ marginBottom: '0.75rem', fontSize: '1.5rem' }}>No Manuals found</h3>
