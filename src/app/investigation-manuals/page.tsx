...
const manualRecords: ManualRecord[] = [
  { sn: 1,  dateRevised: "2026-03-01", refNo: "MNL-A-001", title: "Aircraft Accident Investigation Policy and Procedure Manual", edition: "4th Edition", status: "Active" },
  { sn: 2,  dateRevised: "2026-01-20", refNo: "MNL-M-002", title: "Maritime Casualty Investigation Guidelines",                   edition: "2nd Edition", status: "Active" },
  { sn: 3,  dateRevised: "2025-11-15", refNo: "MNL-R-003", title: "Railway Safety Incident Analysis Manual",                    edition: "1st Edition", status: "Active" },
  { sn: 4,  dateRevised: "2025-09-10", refNo: "MNL-G-004", title: "NSIB Human Factors Investigation Manual",                      edition: "3rd Edition", status: "Active" },
  { sn: 5,  dateRevised: "2025-07-22", refNo: "MNL-G-005", title: "Crisis Communications and Family Assistance Manual",          edition: "2nd Edition", status: "Active" },
  { sn: 6,  dateRevised: "2025-05-18", refNo: "MNL-G-006", title: "FDR and CVR Playback and Analysis Protocols",                edition: "3rd Edition", status: "Active" },
  { sn: 7,  dateRevised: "2025-04-05", refNo: "MNL-A-007", title: "Helicopter Operations Safety Audit Manual",                  edition: "2nd Edition", status: "Active" },
  { sn: 8,  dateRevised: "2025-02-14", refNo: "MNL-G-008", title: "Metallurgical Failure Analysis Guide",                       edition: "1st Edition", status: "Active" },
  { sn: 9,  dateRevised: "2024-12-01", refNo: "MNL-M-009", title: "Inland Waterways Boat Mishap Probe Manual",                   edition: "2nd Edition", status: "Active" },
  { sn: 10, dateRevised: "2024-10-25", refNo: "MNL-R-010", title: "Train Derailment and Track Defect Investigation Proc.",      edition: "1st Edition", status: "Draft" },
  { sn: 11, dateRevised: "2024-09-08", refNo: "MNL-A-011", title: "Weather-Related Aviation Accident Investigation",            edition: "2nd Edition", status: "Active" },
  { sn: 12, dateRevised: "2024-07-15", refNo: "MNL-G-012", title: "Investigator Training and Certification Handout",            edition: "4th Edition", status: "Active" },
  { sn: 13, dateRevised: "2024-05-05", refNo: "MNL-G-013", title: "Drone / UAV Site Mapping Operational Manual",                edition: "1st Edition", status: "Active" },
  { sn: 14, dateRevised: "2024-03-22", refNo: "MNL-A-014", title: "Air Traffic Control Audio Transcript Procedures",             edition: "3rd Edition", status: "Active" },
  { sn: 15, dateRevised: "2023-12-10", refNo: "MNL-G-015", title: "Confidential Aviation Reporting System (CARS) Manual",       edition: "2nd Edition", status: "Active" },
  { sn: 16, dateRevised: "2023-11-05", refNo: "MNL-G-016", title: "Evidence Recovery and Chain of Custody Standard",            edition: "3rd Edition", status: "Active" },
  { sn: 17, dateRevised: "2023-08-14", refNo: "MNL-M-017", title: "Port Terminal Incident Investigation Guide",                 edition: "1st Edition", status: "Active" },
  { sn: 18, dateRevised: "2023-04-20", refNo: "MNL-A-018", title: "Legacy Aircraft Accident Probe Manual",                      edition: "3rd Edition", status: "Archived" },
  { sn: 19, dateRevised: "2022-11-12", refNo: "MNL-G-019", title: "Legacy Human Factors Manual",                                edition: "2nd Edition", status: "Archived" },
  { sn: 20, dateRevised: "2021-08-05", refNo: "MNL-G-020", title: "Basic Safety Investigator Field Guide (2021)",              edition: "1st Edition", status: "Archived" },
];
        ...
        <motion.div className="container" style={{ position: "relative", zIndex: 2, opacity: opacityFade }}
          ...
          <div style={{ maxWidth: "800px" }}>
            ...
            <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.4 }}
              ...
              Access comprehensive manuals, standard operating procedures, and authoritative guidelines shaping NSIB investigations.
            </motion.p>
          </div>
        </motion.div>
      </section>
      ...
      <div className="container" style={{ maxWidth: "1400px" }}>
        ...
        <div style={{ display: "flex", gap: "1rem", marginBottom: "1.5rem", flexWrap: "wrap", alignItems: "center" }}>
          <div style={{ position: "relative", flex: "1 1 260px", maxWidth: "380px" }}>
            ...
            <input type="text" placeholder="Search by title, ref no, edition…"
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", minWidth: "1000px" }}>
              <thead>
                <tr style={{ backgroundColor: "#1B2A6B" }}>
                  ...
                  <TH width="150px">Manual Ref No.</TH>
                  <TH>Document Title</TH>
                  <TH width="120px">Edition</TH>
        ...
        <div style={{ display: "flex", gap: "1.5rem", marginTop: "1.5rem", flexWrap: "wrap", alignItems: "center" }}>
          ...
          {["Active", "Archived", "Draft"].map((label) => {
             const m = {"Active": "#1B2A6B", "Archived": "#64748B", "Draft": "#D97706"} as any;
             return (
