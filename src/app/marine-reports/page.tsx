    ...
    <main style={{ paddingBottom: "8rem", backgroundColor: "var(--bg-primary)", overflowX: "hidden" }}>
      ...
      >
        ...
        <motion.div style={{
          ...
          animate={{ rotateZ: [-15, -10, -15], rotateX: [10, 15, 10], rotateY: [-10, -5, -10], y: [0, -20, 0] }}
          transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.div style={{
          position: "absolute", bottom: "5%", left: "8%",
          width: "280px", height: "280px", borderRadius: "50%",
          background: "linear-gradient(135deg, rgba(0,168,255,0.1) 0%, rgba(0,168,255,0) 100%)",
        ...
        >
          <div style={{ maxWidth: "800px" }}>
            ...
            >
              Access formal navigational investigations, safety records, and findings of maritime incidents across Nigerian waters.
            </motion.p>
          </div>
        </motion.div>
      </section>
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", minWidth: "1000px" }}>
              <thead>
                <tr style={{ backgroundColor: "#1B2A6B" }}>
                  {/* S/No, Date Released, Report No, Vessel Name, Registered Owner/Operator, IMO/REG NO., Vessel Type, Status, Occurrence Type, Report Download  */}
                  <TH width="52px">S/N</TH>
                  <TH width="110px">Date Released</TH>
                  <TH width="140px">Report No.</TH>
                  <TH width="130px">Vessel Name</TH>
                  <TH>Owner / Operator</TH>
                  <TH width="120px">IMO / REG NO.</TH>
                  <TH width="120px">Vessel Type</TH>
              ...
              <tbody>
                {paged.length > 0 ? paged.map((r, idx) => {
                  ...
                  <tr>
                    <td colSpan={10} style={{ padding: "4rem 2rem", textAlign: "center", color: "#94A3B8" }}>
