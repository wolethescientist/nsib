...
const reports = [
  {
    id: 1,
    title: "Derailment of Passenger Train on Lagos-Ibadan Corridor",
    status: "Final Report",
    date: "Jan 12, 2024",
    description: "Comprehensive investigation into the derailment incident detailing track anomalies and speed regulation failures.",
    image: "https://images.unsplash.com/photo-1515162816999-a0c47dc192f7?q=80&w=800&auto=format&fit=crop"
  },
  {
    id: 2,
    title: "Collision on the Abuja-Kaduna Rail Line",
    status: "Preliminary",
    date: "Dec 05, 2023",
    description: "Initial findings covering signaling system failure resulting in a rear-end collision between cargo and passenger units.",
    image: "https://images.unsplash.com/photo-1474487548417-781cb71495f3?q=80&w=800&auto=format&fit=crop"
  },
  {
    id: 3,
    title: "Equipment Failure Alert: Itakpe-Warri Locomotive",
    status: "Safety Advisory",
    date: "Nov 22, 2023",
    description: "Safety advisory documentation regarding repeated brake failure mechanics found in standard gauge cargo variants.",
    image: "https://images.unsplash.com/photo-1560179707-f14e90de1de0?q=80&w=800&auto=format&fit=crop"
  }
];
  ...
  return (
    <main style={{ 
      ...
      <section style={{ 
        ...
        {/* Dynamic Rail Background Layers */}
        <div style={{
          position: 'absolute',
          top: 0,
          left: 0,
        ...
        <div className="floating-element" style={{ position: 'absolute', top: '15%', right: '10%', width: '180px', height: '180px', borderRadius: '30px', background: 'linear-gradient(135deg, rgba(255,255,255,0.08) 0%, rgba(255,255,255,0) 100%)', backdropFilter: 'blur(10px)', border: '1px solid rgba(255,255,255,0.05)', transform: 'rotateZ(25deg)', zIndex: 1 }} />
        <div className="floating-element-slow" style={{ position: 'absolute', bottom: '-5%', left: '10%', width: '300px', height: '300px', borderRadius: '50%', background: 'linear-gradient(135deg, rgba(226,48,48,0.15) 0%, rgba(226,48,48,0) 100%)', backdropFilter: 'blur(20px)', zIndex: 1 }} />
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          <ScrollReveal>
            ...
            <p style={{ 
              ...
              Access comprehensive accident data, preliminary investigations, and final analyses of all railway incidents. Contribute to national safety by submitting observed incidents directly.
            </p>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '1.5rem', alignItems: 'center' }}>
              ...
              <div style={{ position: 'relative', width: '100%', maxWidth: '400px' }}>
                ...
                <input 
                  ...
                  placeholder="Search rail reports..." 
                  value={searchQuery}
              ...
              <button 
                ...
                onClick={() => alert("Trigger file upload or modal here")}
                style={{
                  display: 'flex',
                  alignItems: 'center',
                  gap: '0.75rem',
